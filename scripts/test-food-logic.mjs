...
assert.equal(customFoodServingPreview({ servingSize: "1 serving", portions: [{ name: "bag", weightGrams: 130 }] }).valid, false);
assert.match(customFoodServingPreview({ servingSize: "1 serving", portions: [{ name: "bag", weightGrams: 130 }] }).issues.join(" "), /require a 1 g base/);
assert.equal(customFoodServingPreview({ portions: [{ name: "g", weightGrams: 1 }] }).valid, false);
